...
urlpatterns = [
    ...
    path('APSEC/', views.APSEC, name='APSEC'),
    path('COMPSAC/', views.COMPSAC, name='COMPSAC'),
    path('ECOOP/', views.ECOOP, name='ECOOP'),
    path('ESE/', views.ESE, name='ESE'),
    path('FSE/', views.FSE, name='FSE'),
    path('ICPC/', views.ICPC, name='ICPC'),
    path('ICSE/', views.ICSE, name='ICSE'),
    path('ICSM/', views.ICSM, name='ICSM'),
    path('ICWS/', views.ICWS, name='ICWS'),
    path('OOPLSA/', views.OOPLSA, name='OOPLSA'),
    path('PLDI/', views.PLDI, name='PLDI'),
    path('RSSE/', views.RSSE, name='RSSE'),
    path('SCAM/', views.SCAM, name='SCAM'),
    path('SPLASH/', views.SPLASH, name='SPLASH'),
    path('TOSEM/', views.TOSEM, name='TOSEM'),
    path('TSE/', views.TSE, name='TSE'),
    path('WCRE/', views.WCRE, name='WCRE'),
